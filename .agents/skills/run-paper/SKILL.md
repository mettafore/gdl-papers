...
name: run-paper
description: >
  Run a paper's training or evaluation in the gdl-papers repo. Use when asked to
  "train <paper>", "evaluate <paper>", "run <paper> with lr/epochs/...", or to
  sweep a hyperparameter. Reads the paper's README ## Run + ## Hyperparameters,
