...
% reMarkable 2 screen is 1404x1872 px (3:4 portrait, ratio 1.3333).
% Use a page matching that aspect ratio with slim margins so the whole
% page fills the screen with no panning, and 10pt text appears slightly
% enlarged when scaled to the device width.
...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=0.5\textwidth]{graphics/gravity_moment_4}}
...
%\vskip 0.2in
%\begin{center}
%\centerline{\includegraphics[width=\columnwidth]{graphics/gravity_step_1000}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/layer_equiv}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/filter_equiv_2}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/cg_0}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/equiv_filter_cg}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/moment_10000_steps}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/accuracy_by_epoch_equivariant}}
...
\vskip 0.2in
\begin{center}
\centerline{\includegraphics[width=\columnwidth]{graphics/mae_by_epoch_equivariant}}
