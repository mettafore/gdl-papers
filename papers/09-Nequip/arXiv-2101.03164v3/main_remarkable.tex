...
\usepackage{bm} 
\usepackage{braket}
\providecommand{\mathds}{\mathbb}% dsfont unavailable; mathbb fallback
...
% ===== article needs these explicitly (REVTeX provided them via class options) =====
\usepackage{amsmath}
\usepackage{amssymb}
% ===== reMarkable 3:4 page =====
\usepackage[paperwidth=146mm,paperheight=194.67mm,top=10mm,bottom=12mm,left=11mm,right=11mm,headsep=5pt,footskip=14pt]{geometry}
% ===== REVTeX front-matter shims =====
\makeatletter
\newcommand{\@authblock}{}
\renewcommand{\author}[1]{\g@addto@macro\@authblock{{\normalsize #1}\par\vspace{1pt}}}
\newcommand{\affiliation}[1]{\g@addto@macro\@authblock{{\small\itshape #1}\par\vspace{4pt}}}
...
\newenvironment{widetext}{}{}% REVTeX full-width escape -> no-op in single column
...
\usepackage{seqsplit}    % break long fixed strings (hashes)
\usepackage{microtype}   % tighten lines, reduce overfull
\sloppy
